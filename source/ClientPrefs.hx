...
class ClientPrefs {
	...
	public static function saveSettings() {
		...
		FlxG.save.data.iHYPass = iHYPass;
		FlxG.save.data.mXPass = mXPass;
		FlxG.save.data.warioPass = warioPass;
		FlxG.save.data.betaPass = betaPass;
		FlxG.save.data.carPass = carPass;
		FlxG.save.data.storyPass = storyPass;
		FlxG.save.data.storyFlaut = storyFlaut;
		FlxG.save.data.finish1 = finish1;
	...
	public static function loadPrefs() {
		...
		if(FlxG.save.data.iHYPass != null) {
			iHYPass = FlxG.save.data.iHYPass;
		}
		if(FlxG.save.data.mXPass != null) {
			mXPass = FlxG.save.data.mXPass;
		}
		if(FlxG.save.data.warioPass != null) {
			warioPass = FlxG.save.data.warioPass;
		}
		if(FlxG.save.data.betaPass != null) {
			betaPass = FlxG.save.data.betaPass;
		}
		if(FlxG.save.data.carPass != null) {
			carPass = FlxG.save.data.carPass;
		}
		if(FlxG.save.data.finish1 != null) {
			finish1 = FlxG.save.data.finish1;
		}
		if(FlxG.save.data.storyPass != null) {
			storyPass = FlxG.save.data.storyPass;
		}
		if(FlxG.save.data.storyFlaut != null) {
			storyFlaut = FlxG.save.data.storyFlaut;
		}
