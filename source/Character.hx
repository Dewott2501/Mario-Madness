...
class Character extends FlxSprite
{
	...
	public var superBad:Bool = false;
	...
	public var doIdleReturn:Bool = false;
	...
	public function new(x:Float, y:Float, ?character:String = 'bf', ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			default:
				...
				// if (json.idleReturn.exists())
					doIdleReturn = json.idleReturn;
				// else
					// doIdleReturn = false;
				flipX = !!json.flip_x;
	...
	// 	if (superBad)
	// 	{
	// 		cast(shader, TwoDinThreeD).setXandY(frame.frame.x, frame.frame.y);
	// 	}
	// 	super.draw();
	// }
}
